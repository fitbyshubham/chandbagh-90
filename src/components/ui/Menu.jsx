...
const FilterBadge = ({ icon, children, active }) => (
...
const MenuItem = ({ img, vegType, name, price }) => (
...
const Menu = ({ stallNo, location }) => {
  const menuItems = TypedMenus[stallNo] || [];
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-4xl font-extrabold leading-tight">
              ...
              {Menus.find((s) => s.stallNo === stallNo)?.name || "Stall"} <InfoIcon />
            </h1>
