...
export default function Cart() {
  ...
  return (
    <div className="w-full min-h-screen mt-6 flex flex-col items-center bg-white py-2">
      {/* Header */}
      <div className="flex items-center py-5 relative w-full">
        <button>
          <ArrowLeft className="absolute left-2 top-5 w-6 h-6" />
        </button>
      ...
      {/* Checkout Button */}
      <button className="mt-6 mb-30 w-96 py-3 bg-black text-white rounded-2xl text-lg font-medium shadow-md ">
        Checkout
      </button>
    </div>
  );
